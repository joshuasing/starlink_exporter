...
const file_spacex_api_device_wifi_config_proto_rawDesc = "" +
	...
	" \x01(\bR\x10supports5ghzHighJ\x04\b\x06\x10\aJ\x04\b\b\x10\t\"1\n" +
	"\tTlsConfig\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x12\n" +
	"\x04cert\x18\x02 \x01(\tR\x04cert\"\x8a\x02\n" +
	"\n" +
	"HttpServer\x12\x1f\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.SpaceX.API.Device.MeshConfigR\x05value:\x028\x01\x1a\xb7\x05\n" +
	...
	"authRadius\x12W\n" +
	"\x13auth_open_encrypted\x18\xd6\x0f \x01(\v2$.SpaceX.API.Device.AuthOpenEncryptedH\x00R\x11authOpenEncrypted\x127\n" +
